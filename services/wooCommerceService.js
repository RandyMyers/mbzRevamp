...
class WooCommerceService {
  ...
  mapOrderToWooCommerce(localOrder) {
    return {
      ...
      discount_total: localOrder.discount_total || '0',
      discount_tax: localOrder.discount_tax || '0',
      shipping_total: localOrder.shipping_total || '0',
      shipping_tax: localOrder.shipping_tax || '0',
      cart_tax: localOrder.cart_tax || '0',
      total: localOrder.total || '0',
      total_tax: localOrder.total_tax || '0',
