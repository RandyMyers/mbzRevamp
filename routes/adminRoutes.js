 ...
 */
router.post('/staff/users', adminStaff.createStaff);
/**
 * @swagger
 ...
 */
router.get('/staff/users/:id', adminStaff.getStaff);
/**
 * @swagger
 * /api/admin/staff/users/{id}:
 *   patch:
 ...
 */
router.patch('/staff/users/:id', adminStaff.updateStaff);
/**
 * @swagger
 * /api/admin/staff/users/{id}:
 *   delete:
 ...
 */
router.delete('/staff/users/:id', adminStaff.deleteStaff);
/**
 * @swagger
